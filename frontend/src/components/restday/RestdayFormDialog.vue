    ...
    >
      ...
      <div class="p-6">
        ...
        <div v-if="mode === 'create' || mode === 'edit'" class="space-y-6">
          ...
          <div>
            <label class="block text-sm font-medium text-slate-700 mb-2">
              Restday Date <span class="text-red-500">*</span>
            </label>
            <input
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Brief explanation for restday work..."
            ></textarea>
        ...
        <div v-else-if="mode === 'view' && selectedRecord" class="space-y-6">
          ...
          <div class="grid grid-cols-2 gap-6">
            ...
            <div>
              <p class="text-sm font-medium text-slate-500">Restday Date</p>
        ...
        <div v-else-if="mode === 'delete'" class="flex items-center gap-4">
          ...
          <div>
            <h3 class="text-lg font-medium text-slate-900">Delete Restday Application</h3>
            <p class="text-sm text-slate-600 mt-1">Are you sure you want to delete this restday application? This action cannot be undone.</p>
          </div>
        </div>
      </div>
...
const modalTitle = computed(() => {
  ...
  return titles[props.mode] || 'Restday'
})
...
const validateForm = () => {
  ...
  if (!formData.value.application_date) {
    formErrors.value.application_date = 'Restday date is required'
  }
