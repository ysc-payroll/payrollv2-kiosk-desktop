      ...
      <tbody class="divide-y divide-slate-200">
        ...
        >
          ...
          <td class="px-6 py-4 text-sm text-slate-900">
            ...
            <div v-if="record.terms === 'halfday'" class="text-xs text-slate-500 mt-0.5">
          ...
          <!-- Applied (Original Credits) -->
          <td class="px-6 py-4 text-sm text-slate-900">
            {{ formatCredits(record.original_credits) }}
          </td>

          <!-- Approved (Final Credits) -->
          <td class="px-6 py-4 text-sm text-slate-900">
            {{ record.status === 'approved' ? formatCredits(record.credits) : '-' }}
          </td>
