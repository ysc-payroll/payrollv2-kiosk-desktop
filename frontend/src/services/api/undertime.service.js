/**
 * Undertime Service
 * Handles undertime application CRUD operations
 */

import httpClient from '../http-client.js'
import { BaseCrudService } from './base.service.js'

class UndertimeService extends BaseCrudService {
  constructor(http) {
    super(http, '/api/applications/undertime')
    this.http = http
  }

  /**
   * Get undertime applications with pagination and filters
   */
  async getAll(params = {}) {
  ...
  /**
   * Export undertime applications to CSV
   */
...
const undertimeService = new UndertimeService(httpClient)

export default undertimeService
