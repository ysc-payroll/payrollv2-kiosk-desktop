/**
 * Holiday Service
 * Handles holiday application CRUD operations
 */
...
class HolidayService extends BaseCrudService {
  constructor(http) {
    super(http, '/api/applications/holiday')
    this.http = http
  }
  ...
  /**
   * Create new holiday application (override to use FormData)
   */
  async create(data) {
    try {
  ...
  /**
   * Update holiday application (override to use FormData)
   */
...
const holidayService = new HolidayService(httpClient)
